  ...
  module Support 
    ...
    def formatted_valid_splunk_input
      { 
        ...
        args: {
          earliest_time: Time.parse("2015-10-09T19:55:00").localtime.strftime("%Y-%m-%dT%H:%M:%S.%L%z"),
          latest_time: Time.parse("2015-10-09T20:00:00.100").localtime.strftime("%Y-%m-%dT%H:%M:%S.%L%z")
        }
      }      
    end
